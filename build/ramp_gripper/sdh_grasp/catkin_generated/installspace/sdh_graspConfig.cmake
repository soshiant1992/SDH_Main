...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sdh_grasp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mjmj/catkin_ws_mike/install/${idir}'.  Ask the maintainer 'rishabh <rishabh@todo.todo>' to fix it.")
    endif()
